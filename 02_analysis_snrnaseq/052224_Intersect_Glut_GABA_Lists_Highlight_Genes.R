...
Shared_Glutamatergic_GABAergic <- readxl::read_excel("Peixoto_Figure3_SupplementaryTable_1_v2.xlsx", sheet = "Shared_Glutamatergic_GABAergic")
dim(Shared_Glutamatergic_GABAergic)
# [1] 417  19

Glutamatergic_Only <- readxl::read_excel("Peixoto_Figure3_SupplementaryTable_1_v2.xlsx", sheet = "Glutamatergic_Only")
dim(Glutamatergic_Only)
# [1] 2239   16

GABAergic_Only <- readxl::read_excel("Peixoto_Figure3_SupplementaryTable_1_v2.xlsx", sheet = "GABAergic_Only")
dim(GABAergic_Only)
# [1] 108  11
...
#  [1] "Arc"     "Bdnf"    "Cirbp"   "Cntnap3" "Egr1"    "Fosl2"   "Homer1"  "Hspa5"   "Hspa8"  
# [10] "Nr4a1"   "P4ha1"   "Per1"    "Per2"    "Ube3a"   "Usp50"  
...
# [1] "Bhlhe40"  "Camk1g"   "Cdkn1b"   "Cntn5"    "Cntn6"    "Cntnap4"  "Cntnap5a" "Cntnap5b"
# [9] "Ctnna3"   "Dact2"    "Eif4ebp1" "Fos"      "Fosb"     "Gadd45a"  "Gadd45b"  "Gria1"   
# [17] "Gria4"    "Grin1os"  "Grin2a"   "Grin2d"   "Mef2c"    "Nfatc3"   "Ptgs2"    "Reln"    
# [25] "Sgk1"     "Sik1"     "Sult1a1"  "Tipin"    "Usp43"    "Usp46"    "Wnt1"     "Wnt9a"   
...
# [1] "Eif2s3y" "Npas1"   "Npas2"   "Sst"     "Vip"     "Wnt4"    
