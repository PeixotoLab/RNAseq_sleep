...
points(Homer1_DTU$log10mean, Homer1_DTU$log2FC, pch= 20, col = Homer1_Color, cex = .2, lwd = 2)
points(Homer1_DTU$log10mean, Homer1_DTU$log2FC, pch= 0, col = Homer1_Color, cex = 1.5, lwd = 1.7)

points(Bdnf_DTU$log10mean, Bdnf_DTU$log2FC, pch= 20, col = Bdnf_Color, cex = .2, lwd = 2)
points(Bdnf_DTU$log10mean, Bdnf_DTU$log2FC, pch= 0, col = Bdnf_Color, cex = 1.5, lwd = 1.7)
