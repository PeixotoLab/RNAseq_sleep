...
Transcript_Up_Gene_Names <- c(Transcript_Up_Only_Gene_Names, Transcript_Up_Only_Eifs$Gene_Name, Transcript_Up_Only_Ctnn$Gene_Name, Transcript_Up_Only_Cntn$Gene_Name, Transcript_Up_Only_Hdac$Gene_Name)
sort(Transcript_Up_Gene_Names[!duplicated(Transcript_Up_Gene_Names)])
# [1] "Cntn4"    "Cntnap5c" "Eif2a"    "Eif2b4"   "Eif2d"    "Eif2s3y"  "Eif5"     "Hdac3" 
...
Gene_Up_Gene_Names <- c(Gene_Up_Only_Gene_Names, Gene_Up_Only_Eifs$Gene_Name, Gene_Up_Only_Ctnn$Gene_Name, Gene_Up_Only_Cntn$Gene_Name, Gene_Up_Only_Hdac$Gene_Name)
...
Transcript_Gene_Up_Gene_Names <- c(Transcript_Gene_Up_Gene_Names, Transcript_Gene_Up_Eifs$Gene_Name.x, Transcript_Gene_Up_Ctnn$Gene_Name.x, Transcript_Gene_Up_Cntn$Gene_Name.x, Transcript_Gene_Up_Hdac$Gene_Name.x)
...
# [10] "Gadd45b"  "Hdac8"    "Homer1"   "Hspa5"    "Nr4a1"    "P4ha1"    "Per1"     "Per2"     "Ptgs2"   
# [19] "Sgk1"     "Sik1"     "Sult1a1" 
...
Transcript_Down_Gene_Names <- c(Transcript_Down_Only_Gene_Names, Transcript_Down_Only_Eifs$Gene_Name, Transcript_Down_Only_Ctnn$Gene_Name, Transcript_Down_Only_Cntn$Gene_Name, Transcript_Down_Only_Hdac$Gene_Name)
...
Gene_Down_Gene_Names <- c(Gene_Down_Only_Gene_Names, Gene_Down_Only_Eifs$Gene_Name, Gene_Down_Only_Ctnn$Gene_Name, Gene_Down_Only_Cntn$Gene_Name, Gene_Down_Only_Hdac$Gene_Name)
...
Transcript_Gene_Down_Gene_Names <- c(Transcript_Gene_Down_Gene_Names, Transcript_Gene_Down_Eifs$Gene_Name.x, Transcript_Gene_Down_Ctnn$Gene_Name.x, Transcript_Gene_Down_Cntn$Gene_Name.x, Transcript_Gene_Down_Hdac$Gene_Name.x)
...
# [10] "Nfatc3"   "Opalin"   "Tfrc"     "Tipin"    "Usp43"    "Wnt9a"   
