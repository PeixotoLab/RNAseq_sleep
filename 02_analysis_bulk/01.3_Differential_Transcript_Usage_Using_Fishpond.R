...
# Set colors for Homer1 and Bdnf transcripts
...
points(Homer1_DTU$log10mean, Homer1_DTU$log2FC, pch= 20, col = Homer1_Colors, cex = .2, lwd = 2) # Homer1
points(Homer1_DTU$log10mean, Homer1_DTU$log2FC, pch= 0, col = Homer1_Colors, cex = 1.5, lwd = 1.7) # Homer1
points(Bdnf_DTU$log10mean, Bdnf_DTU$log2FC, pch= 20, col = Bdnf_Colors, cex = .2, lwd = 2) # Bdnf
points(Bdnf_DTU$log10mean, Bdnf_DTU$log2FC, pch= 0, col = Bdnf_Colors, cex = 1.5, lwd = 1.7) # Bdnf
