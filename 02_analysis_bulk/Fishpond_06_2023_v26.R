...
write.table(sQuote(rownames(y)), "Annotated_Lists/063023_Transcript_Background.txt", quote = FALSE, 
...
# write.table(infMed, file = "050323_DTU_InfMed.txt", sep = "\t")
# write.table(infMean, file = "012623_DTU_InfMean.txt", sep = "\t")

# Histogram here:
hist(mcols(y)$pvalue, col="grey", ylim= c(0,15000))
...
# write.table(y_filter, 
#            file = "102722_Differential_Transcript_Usage_Significant_k=3.txt")
